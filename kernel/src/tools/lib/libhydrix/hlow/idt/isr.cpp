...
extern "C" void isr_handler(registers_t *r) {
  if (r->isrNumber < 32) {
    ...
    asm volatile(
        ...
        HY_IDT_CONSOLE->WriteLineS("--[BEGIN KERNEL PANIC]--", rgb(255, 0, 0));
        HY_IDT_CONSOLE->WriteLineS("An exception has occured that the kernel cannot recover from.", rgb(255, 0, 0));
        HY_IDT_CONSOLE->WriteLineS(strcat("Interrupt Number: ", to_string(r->isrNumber)), rgb(255, 0, 0));
        HY_IDT_CONSOLE->WriteLineS(strcat("Interrupt Error: ", exceptionMessages[r->isrNumber]), rgb(255, 0, 0));
        HY_IDT_CONSOLE->WriteLineS(strcat("RIP: ", strcat("0x", to_string_hex(r->rip))), rgb(255, 0, 0));
        HY_IDT_CONSOLE->WriteLineS(strcat("RSP: ", strcat("0x", to_string_hex(r->rsp))), rgb(255, 0, 0));
        HY_IDT_CONSOLE->WriteLineS(strcat("RAX: ", strcat("0x", to_string_hex(r->rax))), rgb(255, 0, 0));
        HY_IDT_CONSOLE->WriteLineS(strcat("RBX: ", strcat("0x", to_string_hex(r->rbx))), rgb(255, 0, 0));
        HY_IDT_CONSOLE->WriteLineS(strcat("RCX: ", strcat("0x", to_string_hex(r->rcx))), rgb(255, 0, 0));
        HY_IDT_CONSOLE->WriteLineS(strcat("RDX: ", strcat("0x", to_string_hex(r->rdx))), rgb(255, 0, 0));
        HY_IDT_CONSOLE->WriteLineS(strcat("RBP: ", strcat("0x", to_string_hex(r->rbp))), rgb(255, 0, 0));
        HY_IDT_CONSOLE->WriteLineS(strcat("RDI: ", strcat("0x", to_string_hex(r->rdi))), rgb(255, 0, 0));
        HY_IDT_CONSOLE->WriteLineS(strcat("RSI: ", strcat("0x", to_string_hex(r->rsi))), rgb(255, 0, 0));
        HY_IDT_CONSOLE->WriteLineS(strcat("R8:  ", strcat("0x", to_string_hex(r->r8))), rgb(255, 0, 0));
        HY_IDT_CONSOLE->WriteLineS(strcat("R9:  ", strcat("0x", to_string_hex(r->r9))), rgb(255, 0, 0));
        HY_IDT_CONSOLE->WriteLineS(strcat("R10: ", strcat("0x", to_string_hex(r->r10))), rgb(255, 0, 0));
        HY_IDT_CONSOLE->WriteLineS(strcat("R11: ", strcat("0x", to_string_hex(r->r11))), rgb(255, 0, 0));
        HY_IDT_CONSOLE->WriteLineS(strcat("R12: ", strcat("0x", to_string_hex(r->r12))), rgb(255, 0, 0));
        HY_IDT_CONSOLE->WriteLineS(strcat("R13: ", strcat("0x", to_string_hex(r->r13))), rgb(255, 0, 0));
        HY_IDT_CONSOLE->WriteLineS(strcat("R14: ", strcat("0x", to_string_hex(r->r14))), rgb(255, 0, 0));
        HY_IDT_CONSOLE->WriteLineS(strcat("R15: ", strcat("0x", to_string_hex(r->r15))), rgb(255, 0, 0));
        HY_IDT_CONSOLE->WriteLineS(strcat("CR2: ", strcat("0x", to_string_hex(cr2))), rgb(255, 0, 0));
        HY_IDT_CONSOLE->WriteLineS("--[END KERNEL PANIC]--", rgb(255, 0, 0));
        asm volatile("cli");
