...
override IMAGE_NAME := LibHydrixTemplate
...
$(IMAGE_NAME).iso: limine kernel
	...
	rm -rf iso_root
	qemu-system-x86_64 -m 4G -cpu max -cdrom $(IMAGE_NAME).iso -boot d -audiodev pa,id=speaker -machine pcspk-audiodev=speaker
